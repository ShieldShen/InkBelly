...
public abstract class Worker<P, R> {
    ...
    protected abstract R run(P product, Bundle bundle, List<R> lastResult) throws Exception;

    R process(P product, Bundle bundle, List<R> lastResult) throws Exception {
        if (filters != null) {
